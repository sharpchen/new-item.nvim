    ...
    sources = {
      {
        name = 'builtin',
        function(add_items)
          require('new-item.groups.dotnet').register_items(
            function(items) add_items(items) end
          )
        end,
      },
    },
...
M.gitignore = {
  visible = false,
  sources = {
    { name = 'builtin', 'new-item.groups.gitignore' },
  },
}
...
M.gitattributes = {
  visible = false,
  sources = {
    { name = 'builtin', 'new-item.groups.gitattributes' },
  },
}
